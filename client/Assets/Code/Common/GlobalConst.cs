...
{
    public static bool IS_DEVELOP = true; //开发者模式（true：不开启热更新，false：开启热更新）
	...
	//排位赛（新）
	public const string DIR_XML_QUALIFYING_NEW = DIR_XML_FUNC + "QualifyingNew";
	public const string DIR_XML_QUALIFYING_NEW_SEASON = DIR_XML_FUNC + "QualifyingNewSeason";
    //物品
	...
	public static float ROTATE_ANGLE_SEC = 22.5f;
	public static uint PVP_VALID_LATENCY = 100; //PVP网速限制

    public static uint ALL_HEDGING_ID = 100;

	public static float MATCHED_KEY_BLOCK_RATE_ADJUST = 1.0f;

	public static float CHARACTER_SKIN_WIDTH = 0.01f;
}
