...
namespace UnityEditor.XCodeEditor 
{
	public class XCMod 
	{
		...
		public ArrayList framepaths {
			get {
				return (ArrayList)_datastore["framepaths"];
			}
		}
		public ArrayList libpaths {
			get {
				return (ArrayList)_datastore["libpaths"];
			}
		}
		...
		public string plist {
			get {
				if(((ArrayList)_datastore["plist"]).Count>0)
					return (string)((ArrayList)_datastore["plist"])[0];
				return string.Empty;
			}
		}
		public ArrayList Controller {
			get {
				if(((ArrayList)_datastore["Controller"]).Count>0)
					return (ArrayList)_datastore["Controller"];
				return null;
			}
		}
