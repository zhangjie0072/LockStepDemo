public class MatchStateMachine_PVP : MatchStateMachine
{
	...
	{
		m_arStateList[(int)MatchState.State.eTipOff] = new MatchStateTipOff_PVP(this);
		m_arStateList[(int)MatchState.State.eOpening] = new MatchStateOpening(this);
		m_arStateList[(int)MatchState.State.eBegin] = new MatchStateBegin_PVP(this);
        m_arStateList[(int)MatchState.State.ePlaying] = new MatchStatePlaying_PVP(this);
        m_arStateList[(int)MatchState.State.eGoal] = new MatchStateGoal_PVP(this);
        ...
        m_arStateList[(int)MatchState.State.eFoul] = new MatchStateFoul_PVP(this);
