...
public class UIDragDropItem : MonoBehaviour
{
    /// <summary>
    /// libing 
    /// 鍏嬮殕瀵硅薄澧炲姞鍘熷?瀵硅薄鐨勫彉閲忥紝浠ユ柟渚垮湪鍘熷?瀵硅薄涓婃敞鍐屽洖璋冧簨浠躲佁
    /// cloneOnDrag==True鏃剁敓鏁堬紝鍚﹀垯杩欎釜鍊间负null
    /// </summary>
    public UIDragDropItem originalItem; 
	...
	public void SetLimit(float minx, float maxx, float miny, float maxy)
	{
		isLimit = true;
		minX = minx;
		maxX = maxx;
...
#region Common functionality
	...
	{
		Vector3 pos = mTrans.localPosition + delta;
		if(isLimit)
		{
