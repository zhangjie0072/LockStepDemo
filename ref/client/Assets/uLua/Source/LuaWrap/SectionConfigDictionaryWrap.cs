...
public class SectionConfigDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateSectionConfigDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "SectionConfigDictionary", typeof(Dictionary<uint,fogs.proto.config.SectionConfig>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateSectionConfigDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,fogs.proto.config.SectionConfig> obj = new Dictionary<uint,fogs.proto.config.SectionConfig>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,fogs.proto.config.SectionConfig> obj = new Dictionary<uint,fogs.proto.config.SectionConfig>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,fogs.proto.config.SectionConfig>)))
		{
			IDictionary<uint,fogs.proto.config.SectionConfig> arg0 = (IDictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,fogs.proto.config.SectionConfig>));
			Dictionary<uint,fogs.proto.config.SectionConfig> obj = new Dictionary<uint,fogs.proto.config.SectionConfig>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,fogs.proto.config.SectionConfig> obj = new Dictionary<uint,fogs.proto.config.SectionConfig>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,fogs.proto.config.SectionConfig>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,fogs.proto.config.SectionConfig> arg0 = (IDictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,fogs.proto.config.SectionConfig>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,fogs.proto.config.SectionConfig> obj = new Dictionary<uint,fogs.proto.config.SectionConfig>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,fogs.proto.config.SectionConfig>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,fogs.proto.config.SectionConfig>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,fogs.proto.config.SectionConfig>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		fogs.proto.config.SectionConfig o = obj[arg0];
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,fogs.proto.config.SectionConfig>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		fogs.proto.config.SectionConfig arg1 = (fogs.proto.config.SectionConfig)LuaScriptMgr.GetNetObject(L, 3, typeof(fogs.proto.config.SectionConfig));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,fogs.proto.config.SectionConfig>");
		fogs.proto.config.SectionConfig arg0 = (fogs.proto.config.SectionConfig)LuaScriptMgr.GetNetObject(L, 2, typeof(fogs.proto.config.SectionConfig));
	...
	static int TryGetValue(IntPtr L)
	{
		...
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,fogs.proto.config.SectionConfig>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		fogs.proto.config.SectionConfig arg1 = null;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,fogs.proto.config.SectionConfig> obj = (Dictionary<uint,fogs.proto.config.SectionConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,fogs.proto.config.SectionConfig>");
		Dictionary<uint,fogs.proto.config.SectionConfig>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
