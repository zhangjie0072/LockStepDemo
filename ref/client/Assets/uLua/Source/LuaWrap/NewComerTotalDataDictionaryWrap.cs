...
public class NewComerTotalDataDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateNewComerTotalDataDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "NewComerTotalDataDictionary", typeof(Dictionary<uint,NewComerTotalData>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateNewComerTotalDataDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,NewComerTotalData> obj = new Dictionary<uint,NewComerTotalData>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,NewComerTotalData> obj = new Dictionary<uint,NewComerTotalData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,NewComerTotalData>)))
		{
			IDictionary<uint,NewComerTotalData> arg0 = (IDictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,NewComerTotalData>));
			Dictionary<uint,NewComerTotalData> obj = new Dictionary<uint,NewComerTotalData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,NewComerTotalData> obj = new Dictionary<uint,NewComerTotalData>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,NewComerTotalData>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,NewComerTotalData> arg0 = (IDictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,NewComerTotalData>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,NewComerTotalData> obj = new Dictionary<uint,NewComerTotalData>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,NewComerTotalData>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,NewComerTotalData>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,NewComerTotalData> obj = (Dictionary<uint,NewComerTotalData>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,NewComerTotalData> obj = (Dictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerTotalData>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		NewComerTotalData o = obj[arg0];
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,NewComerTotalData> obj = (Dictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerTotalData>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		NewComerTotalData arg1 = (NewComerTotalData)LuaScriptMgr.GetNetObject(L, 3, typeof(NewComerTotalData));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,NewComerTotalData> obj = (Dictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerTotalData>");
		NewComerTotalData arg0 = (NewComerTotalData)LuaScriptMgr.GetNetObject(L, 2, typeof(NewComerTotalData));
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,NewComerTotalData> obj = (Dictionary<uint,NewComerTotalData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerTotalData>");
		Dictionary<uint,NewComerTotalData>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
