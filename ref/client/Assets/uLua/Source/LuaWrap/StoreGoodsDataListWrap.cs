...
public class StoreGoodsDataListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateStoreGoodsDataList),
		...
		LuaScriptMgr.RegisterLib(L, "StoreGoodsDataList", typeof(List<StoreGoodsData>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateStoreGoodsDataList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<StoreGoodsData> obj = new List<StoreGoodsData>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<StoreGoodsData> obj = new List<StoreGoodsData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<StoreGoodsData>)))
		{
			IEnumerable<StoreGoodsData> arg0 = (IEnumerable<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<StoreGoodsData>));
			List<StoreGoodsData> obj = new List<StoreGoodsData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<StoreGoodsData>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<StoreGoodsData> obj = (List<StoreGoodsData>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
		IEnumerable<StoreGoodsData> arg0 = (IEnumerable<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<StoreGoodsData>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
		System.Collections.ObjectModel.ReadOnlyCollection<StoreGoodsData> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
			StoreGoodsData[] objs0 = LuaScriptMgr.GetArrayObject<StoreGoodsData>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			StoreGoodsData[] objs1 = LuaScriptMgr.GetArrayObject<StoreGoodsData>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		StoreGoodsData o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<StoreGoodsData> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<StoreGoodsData> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<StoreGoodsData>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<StoreGoodsData> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<StoreGoodsData>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
		Action<StoreGoodsData> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<StoreGoodsData>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
		List<StoreGoodsData>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<StoreGoodsData> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<StoreGoodsData> arg1 = (IEnumerable<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<StoreGoodsData>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<StoreGoodsData>), typeof(Comparison<StoreGoodsData>)))
		{
			List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
			Comparison<StoreGoodsData> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<StoreGoodsData>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<StoreGoodsData>), typeof(IComparer<StoreGoodsData>)))
		{
			List<StoreGoodsData> obj = (List<StoreGoodsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<StoreGoodsData>");
			IComparer<StoreGoodsData> arg0 = (IComparer<StoreGoodsData>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<StoreGoodsData> arg2 = (IComparer<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<StoreGoodsData>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<StoreGoodsData>.Sort");
		}
