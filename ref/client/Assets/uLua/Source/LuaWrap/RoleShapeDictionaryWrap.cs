...
public class RoleShapeDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateRoleShapeDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "RoleShapeDictionary", typeof(Dictionary<uint,RoleShape>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateRoleShapeDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,RoleShape> obj = new Dictionary<uint,RoleShape>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,RoleShape> obj = new Dictionary<uint,RoleShape>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,RoleShape>)))
		{
			IDictionary<uint,RoleShape> arg0 = (IDictionary<uint,RoleShape>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,RoleShape>));
			Dictionary<uint,RoleShape> obj = new Dictionary<uint,RoleShape>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,RoleShape> obj = new Dictionary<uint,RoleShape>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,RoleShape>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,RoleShape> arg0 = (IDictionary<uint,RoleShape>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,RoleShape>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,RoleShape> obj = new Dictionary<uint,RoleShape>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,RoleShape>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,RoleShape>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,RoleShape> obj = (Dictionary<uint,RoleShape>)o;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,RoleShape> obj = (Dictionary<uint,RoleShape>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,RoleShape>");
		Dictionary<uint,RoleShape>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
