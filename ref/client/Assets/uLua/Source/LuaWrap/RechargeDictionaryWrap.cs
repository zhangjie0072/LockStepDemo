...
public class RechargeDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateRechargeDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "RechargeDictionary", typeof(Dictionary<uint,Recharge>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateRechargeDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,Recharge> obj = new Dictionary<uint,Recharge>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,Recharge> obj = new Dictionary<uint,Recharge>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Recharge>)))
		{
			IDictionary<uint,Recharge> arg0 = (IDictionary<uint,Recharge>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Recharge>));
			Dictionary<uint,Recharge> obj = new Dictionary<uint,Recharge>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,Recharge> obj = new Dictionary<uint,Recharge>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Recharge>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,Recharge> arg0 = (IDictionary<uint,Recharge>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Recharge>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,Recharge> obj = new Dictionary<uint,Recharge>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,Recharge>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,Recharge>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,Recharge> obj = (Dictionary<uint,Recharge>)o;
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,Recharge> obj = (Dictionary<uint,Recharge>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Recharge>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		Recharge arg1 = (Recharge)LuaScriptMgr.GetNetObject(L, 3, typeof(Recharge));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,Recharge> obj = (Dictionary<uint,Recharge>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Recharge>");
		Recharge arg0 = (Recharge)LuaScriptMgr.GetNetObject(L, 2, typeof(Recharge));
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,Recharge> obj = (Dictionary<uint,Recharge>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Recharge>");
		Dictionary<uint,Recharge>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
