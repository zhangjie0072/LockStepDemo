...
public class UIInputWrap
{
	public static void Register(IntPtr L)
	{
		...
		{
			new LuaMethod("FinallyLimit", FinallyLimit),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("finallyLimit", get_finallyLimit, set_finallyLimit),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_finallyLimit(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIInput obj = (UIInput)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name finallyLimit");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index finallyLimit on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.finallyLimit);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_finallyLimit(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIInput obj = (UIInput)o;
		...
		obj.finallyLimit = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int FinallyLimit(IntPtr L)
	{
