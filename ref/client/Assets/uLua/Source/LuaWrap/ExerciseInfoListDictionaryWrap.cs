...
public class ExerciseInfoListDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateExerciseInfoListDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "ExerciseInfoListDictionary", typeof(Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateExerciseInfoListDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = new Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = new Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)))
		{
			IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>> arg0 = (IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>));
			Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = new Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = new Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>> arg0 = (IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,List<fogs.proto.msg.ExerciseInfo>>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = new Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		List<fogs.proto.msg.ExerciseInfo> o = obj[arg0];
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		List<fogs.proto.msg.ExerciseInfo> arg1 = (List<fogs.proto.msg.ExerciseInfo>)LuaScriptMgr.GetNetObject(L, 3, typeof(List<fogs.proto.msg.ExerciseInfo>));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>");
		List<fogs.proto.msg.ExerciseInfo> arg0 = (List<fogs.proto.msg.ExerciseInfo>)LuaScriptMgr.GetNetObject(L, 2, typeof(List<fogs.proto.msg.ExerciseInfo>));
	...
	static int TryGetValue(IntPtr L)
	{
		...
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		System.Collections.Generic.List<fogs.proto.msg.ExerciseInfo> arg1 = null;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>> obj = (Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>");
		Dictionary<uint,List<fogs.proto.msg.ExerciseInfo>>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
