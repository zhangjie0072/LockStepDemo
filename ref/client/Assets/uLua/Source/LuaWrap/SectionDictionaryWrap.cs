...
public class SectionDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateSectionDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "SectionDictionary", typeof(Dictionary<uint,Section>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateSectionDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,Section> obj = new Dictionary<uint,Section>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,Section> obj = new Dictionary<uint,Section>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Section>)))
		{
			IDictionary<uint,Section> arg0 = (IDictionary<uint,Section>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Section>));
			Dictionary<uint,Section> obj = new Dictionary<uint,Section>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,Section> obj = new Dictionary<uint,Section>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Section>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,Section> arg0 = (IDictionary<uint,Section>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Section>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,Section> obj = new Dictionary<uint,Section>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,Section>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,Section>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,Section> obj = (Dictionary<uint,Section>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,Section> obj = (Dictionary<uint,Section>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Section>");
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,Section> obj = (Dictionary<uint,Section>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Section>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		Section arg1 = (Section)LuaScriptMgr.GetNetObject(L, 3, typeof(Section));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,Section> obj = (Dictionary<uint,Section>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Section>");
		Section arg0 = (Section)LuaScriptMgr.GetNetObject(L, 2, typeof(Section));
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,Section> obj = (Dictionary<uint,Section>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Section>");
		Dictionary<uint,Section>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
