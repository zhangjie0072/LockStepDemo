...
public class WidgetPlaceholderWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateWidgetPlaceholder),
		...
		LuaScriptMgr.RegisterLib(L, "WidgetPlaceholder", typeof(WidgetPlaceholder), regs, fields, typeof(MonoBehaviour));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateWidgetPlaceholder(IntPtr L)
	{
		LuaDLL.luaL_error(L, "WidgetPlaceholder class does not have a constructor function");
		return 0;
	}

	static Type classType = typeof(WidgetPlaceholder);
