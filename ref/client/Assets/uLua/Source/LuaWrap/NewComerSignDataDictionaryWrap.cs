...
public class NewComerSignDataDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateNewComerSignDataDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "NewComerSignDataDictionary", typeof(Dictionary<uint,NewComerSignData>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateNewComerSignDataDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,NewComerSignData> obj = new Dictionary<uint,NewComerSignData>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,NewComerSignData> obj = new Dictionary<uint,NewComerSignData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,NewComerSignData>)))
		{
			IDictionary<uint,NewComerSignData> arg0 = (IDictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,NewComerSignData>));
			Dictionary<uint,NewComerSignData> obj = new Dictionary<uint,NewComerSignData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,NewComerSignData> obj = new Dictionary<uint,NewComerSignData>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,NewComerSignData>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,NewComerSignData> arg0 = (IDictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,NewComerSignData>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,NewComerSignData> obj = new Dictionary<uint,NewComerSignData>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,NewComerSignData>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,NewComerSignData>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,NewComerSignData> obj = (Dictionary<uint,NewComerSignData>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,NewComerSignData> obj = (Dictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerSignData>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		NewComerSignData o = obj[arg0];
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,NewComerSignData> obj = (Dictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerSignData>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		NewComerSignData arg1 = (NewComerSignData)LuaScriptMgr.GetNetObject(L, 3, typeof(NewComerSignData));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,NewComerSignData> obj = (Dictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerSignData>");
		NewComerSignData arg0 = (NewComerSignData)LuaScriptMgr.GetNetObject(L, 2, typeof(NewComerSignData));
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,NewComerSignData> obj = (Dictionary<uint,NewComerSignData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,NewComerSignData>");
		Dictionary<uint,NewComerSignData>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
