...
public class SkillSlotProtoListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateSkillSlotProtoList),
		...
		LuaScriptMgr.RegisterLib(L, "SkillSlotProtoList", typeof(List<fogs.proto.msg.SkillSlotProto>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateSkillSlotProtoList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<fogs.proto.msg.SkillSlotProto> obj = new List<fogs.proto.msg.SkillSlotProto>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<fogs.proto.msg.SkillSlotProto> obj = new List<fogs.proto.msg.SkillSlotProto>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<fogs.proto.msg.SkillSlotProto>)))
		{
			IEnumerable<fogs.proto.msg.SkillSlotProto> arg0 = (IEnumerable<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<fogs.proto.msg.SkillSlotProto>));
			List<fogs.proto.msg.SkillSlotProto> obj = new List<fogs.proto.msg.SkillSlotProto>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<fogs.proto.msg.SkillSlotProto>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		IEnumerable<fogs.proto.msg.SkillSlotProto> arg0 = (IEnumerable<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<fogs.proto.msg.SkillSlotProto>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		System.Collections.ObjectModel.ReadOnlyCollection<fogs.proto.msg.SkillSlotProto> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
			fogs.proto.msg.SkillSlotProto[] objs0 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.SkillSlotProto>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			fogs.proto.msg.SkillSlotProto[] objs1 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.SkillSlotProto>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		fogs.proto.msg.SkillSlotProto o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<fogs.proto.msg.SkillSlotProto> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<fogs.proto.msg.SkillSlotProto> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<fogs.proto.msg.SkillSlotProto>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<fogs.proto.msg.SkillSlotProto> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<fogs.proto.msg.SkillSlotProto>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		Action<fogs.proto.msg.SkillSlotProto> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<fogs.proto.msg.SkillSlotProto>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		List<fogs.proto.msg.SkillSlotProto>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<fogs.proto.msg.SkillSlotProto> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<fogs.proto.msg.SkillSlotProto> arg1 = (IEnumerable<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<fogs.proto.msg.SkillSlotProto>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.SkillSlotProto>), typeof(Comparison<fogs.proto.msg.SkillSlotProto>)))
		{
			List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
			Comparison<fogs.proto.msg.SkillSlotProto> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.SkillSlotProto>), typeof(IComparer<fogs.proto.msg.SkillSlotProto>)))
		{
			List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
			IComparer<fogs.proto.msg.SkillSlotProto> arg0 = (IComparer<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<fogs.proto.msg.SkillSlotProto> arg2 = (IComparer<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<fogs.proto.msg.SkillSlotProto>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.SkillSlotProto>.Sort");
		}
	...
	static int ToArray(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.SkillSlotProto> obj = (List<fogs.proto.msg.SkillSlotProto>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.SkillSlotProto>");
		fogs.proto.msg.SkillSlotProto[] o = obj.ToArray();
