...
public class UIPanelWrap
{
	...
	static int set_widgets(IntPtr L)
	{
		...
		obj.widgets = (BetterList<UIWidget>)LuaScriptMgr.GetNetObject(L, 3, typeof(BetterList<UIWidget>));
		return 0;
	}
	...
	static int set_drawCalls(IntPtr L)
	{
		...
		obj.drawCalls = (BetterList<UIDrawCall>)LuaScriptMgr.GetNetObject(L, 3, typeof(BetterList<UIDrawCall>));
		return 0;
	}
	...
	static int GetMainGameViewSize(IntPtr L)
	{
		...
		Vector2 o = UIPanel.GetMainGameViewSize();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
#endif
