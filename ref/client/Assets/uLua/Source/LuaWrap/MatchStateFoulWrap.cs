...
public class MatchStateFoulWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateMatchStateFoul),
		...
		LuaScriptMgr.RegisterLib(L, "MatchStateFoul", typeof(MatchStateFoul), regs, fields, typeof(MatchState));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateMatchStateFoul(IntPtr L)
	{
		...
		if (count == 1)
		{
			...
			MatchStateFoul obj = new MatchStateFoul(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: MatchStateFoul.New");
		}

		return 0;
	}

	static Type classType = typeof(MatchStateFoul);
	...
	static int OnEnter(IntPtr L)
	{
		...
		MatchStateFoul obj = (MatchStateFoul)LuaScriptMgr.GetNetObjectSelf(L, 1, "MatchStateFoul");
