...
public class FashionShopConfigItemDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateFashionShopConfigItemDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "FashionShopConfigItemDictionary", typeof(Dictionary<uint,FashionShopConfigItem>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateFashionShopConfigItemDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,FashionShopConfigItem> obj = new Dictionary<uint,FashionShopConfigItem>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,FashionShopConfigItem> obj = new Dictionary<uint,FashionShopConfigItem>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,FashionShopConfigItem>)))
		{
			IDictionary<uint,FashionShopConfigItem> arg0 = (IDictionary<uint,FashionShopConfigItem>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,FashionShopConfigItem>));
			Dictionary<uint,FashionShopConfigItem> obj = new Dictionary<uint,FashionShopConfigItem>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,FashionShopConfigItem> obj = new Dictionary<uint,FashionShopConfigItem>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,FashionShopConfigItem>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,FashionShopConfigItem> arg0 = (IDictionary<uint,FashionShopConfigItem>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,FashionShopConfigItem>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,FashionShopConfigItem> obj = new Dictionary<uint,FashionShopConfigItem>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,FashionShopConfigItem>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,FashionShopConfigItem>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,FashionShopConfigItem> obj = (Dictionary<uint,FashionShopConfigItem>)o;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,FashionShopConfigItem> obj = (Dictionary<uint,FashionShopConfigItem>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,FashionShopConfigItem>");
		Dictionary<uint,FashionShopConfigItem>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
