...
public class UIButtonWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("isPressed", get_isPressed, set_isPressed),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isPressed(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIButton obj = (UIButton)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name isPressed");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index isPressed on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.isPressed);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_isPressed(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UIButton obj = (UIButton)o;
		...
		obj.isPressed = LuaScriptMgr.GetBoolean(L, 3);
		return 0;
	}
