...
public class UITableWrap
{
	public static void Register(IntPtr L)
	{
		...
		{
			new LuaField("x_offset", get_x_offset, set_x_offset),
			new LuaField("y_offset", get_y_offset, set_y_offset),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_x_offset(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			{
				LuaDLL.luaL_error(L, "unknown member name x_offset");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index x_offset on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.x_offset);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_y_offset(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UITable obj = (UITable)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name y_offset");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index y_offset on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.y_offset);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_x_offset(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UITable obj = (UITable)o;
		...
		obj.x_offset = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_y_offset(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		UITable obj = (UITable)o;
		...
		obj.y_offset = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
