...
public class StringListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateStringList),
		...
		LuaScriptMgr.RegisterLib(L, "StringList", typeof(List<string>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateStringList(IntPtr L)
	{
		...
		{
			IEnumerable<string> arg0 = (IEnumerable<string>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<string>));
			List<string> obj = new List<string>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
	...
	static Type classType = typeof(List<string>);
	...
	static int Add(IntPtr L)
	{
		...
		List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
		IEnumerable<string> arg0 = (IEnumerable<string>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<string>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int BinarySearch(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
			string arg0 = LuaScriptMgr.GetLuaString(L, 2);
			IComparer<string> arg1 = (IComparer<string>)LuaScriptMgr.GetNetObject(L, 3, typeof(IComparer<string>));
		...
		else if (count == 5)
		{
			...
			IComparer<string> arg3 = (IComparer<string>)LuaScriptMgr.GetNetObject(L, 5, typeof(IComparer<string>));
	...
	static int Exists(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
		Predicate<string> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Predicate<string>)LuaScriptMgr.GetNetObject(L, 2, typeof(Predicate<string>));
		}
		else
		{
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<string> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<string>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<string>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<string> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<string>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<string>));
			}
			else
			{
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
		Action<string> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<string>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<string>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<string> arg1 = (IEnumerable<string>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<string>));
	...
	static int Sort(IntPtr L)
	{
		...
		{
			List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
			Comparison<string> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<string>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		{
			List<string> obj = (List<string>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<string>");
			IComparer<string> arg0 = (IComparer<string>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<string> arg2 = (IComparer<string>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<string>));
