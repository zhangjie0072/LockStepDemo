...
public class UnityTimeWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			new LuaMethod("New", _CreateUnityTime),
		...
		LuaScriptMgr.RegisterLib(L, "UnityTime", typeof(Time), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateUnityTime(IntPtr L)
	{
