...
public class UintDictionaryDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateUintDictionaryDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "UintDictionaryDictionary", typeof(Dictionary<uint,Dictionary<uint,uint>>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateUintDictionaryDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,Dictionary<uint,uint>> obj = new Dictionary<uint,Dictionary<uint,uint>>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,Dictionary<uint,uint>> obj = new Dictionary<uint,Dictionary<uint,uint>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Dictionary<uint,uint>>)))
		{
			IDictionary<uint,Dictionary<uint,uint>> arg0 = (IDictionary<uint,Dictionary<uint,uint>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Dictionary<uint,uint>>));
			Dictionary<uint,Dictionary<uint,uint>> obj = new Dictionary<uint,Dictionary<uint,uint>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,Dictionary<uint,uint>> obj = new Dictionary<uint,Dictionary<uint,uint>>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,Dictionary<uint,uint>>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,Dictionary<uint,uint>> arg0 = (IDictionary<uint,Dictionary<uint,uint>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,Dictionary<uint,uint>>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,Dictionary<uint,uint>> obj = new Dictionary<uint,Dictionary<uint,uint>>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,Dictionary<uint,uint>>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,Dictionary<uint,uint>>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,Dictionary<uint,uint>> obj = (Dictionary<uint,Dictionary<uint,uint>>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,Dictionary<uint,uint>> obj = (Dictionary<uint,Dictionary<uint,uint>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Dictionary<uint,uint>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		Dictionary<uint,uint> o = obj[arg0];
	...
	static int TryGetValue(IntPtr L)
	{
		...
		Dictionary<uint,Dictionary<uint,uint>> obj = (Dictionary<uint,Dictionary<uint,uint>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Dictionary<uint,uint>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		System.Collections.Generic.Dictionary<System.UInt32,System.UInt32> arg1 = null;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,Dictionary<uint,uint>> obj = (Dictionary<uint,Dictionary<uint,uint>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,Dictionary<uint,uint>>");
		Dictionary<uint,Dictionary<uint,uint>>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
