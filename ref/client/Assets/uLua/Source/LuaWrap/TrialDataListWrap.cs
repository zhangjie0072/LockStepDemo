...
public class TrialDataListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateTrialDataList),
		...
		LuaScriptMgr.RegisterLib(L, "TrialDataList", typeof(List<TrialData>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateTrialDataList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<TrialData> obj = new List<TrialData>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<TrialData> obj = new List<TrialData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<TrialData>)))
		{
			IEnumerable<TrialData> arg0 = (IEnumerable<TrialData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<TrialData>));
			List<TrialData> obj = new List<TrialData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<TrialData>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<TrialData> obj = (List<TrialData>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		IEnumerable<TrialData> arg0 = (IEnumerable<TrialData>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<TrialData>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		System.Collections.ObjectModel.ReadOnlyCollection<TrialData> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
			TrialData[] objs0 = LuaScriptMgr.GetArrayObject<TrialData>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			TrialData[] objs1 = LuaScriptMgr.GetArrayObject<TrialData>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.CopyTo");
		}
	...
	static int Exists(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		Predicate<TrialData> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Predicate<TrialData>)LuaScriptMgr.GetNetObject(L, 2, typeof(Predicate<TrialData>));
		}
		else
		{
	...
	static int FindAll(IntPtr L)
	{
		...
		List<TrialData> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<TrialData> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<TrialData>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<TrialData>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<TrialData> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<TrialData>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<TrialData>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		Action<TrialData> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<TrialData>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<TrialData>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		List<TrialData>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<TrialData> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<TrialData> arg1 = (IEnumerable<TrialData>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<TrialData>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<TrialData>), typeof(Comparison<TrialData>)))
		{
			List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
			Comparison<TrialData> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<TrialData>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<TrialData>), typeof(IComparer<TrialData>)))
		{
			List<TrialData> obj = (List<TrialData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<TrialData>");
			IComparer<TrialData> arg0 = (IComparer<TrialData>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<TrialData> arg2 = (IComparer<TrialData>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<TrialData>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<TrialData>.Sort");
		}
