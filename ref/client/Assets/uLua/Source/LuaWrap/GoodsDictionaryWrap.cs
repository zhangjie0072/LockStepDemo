...
public class GoodsDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateGoodsDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "GoodsDictionary", typeof(Dictionary<ulong,Goods>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGoodsDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<ulong,Goods>)))
		{
			IDictionary<ulong,Goods> arg0 = (IDictionary<ulong,Goods>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<ulong,Goods>));
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEqualityComparer<ulong>)))
		{
			IEqualityComparer<ulong> arg0 = (IEqualityComparer<ulong>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEqualityComparer<ulong>));
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<ulong>)))
		{
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 1);
			IEqualityComparer<ulong> arg1 = (IEqualityComparer<ulong>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<ulong>));
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<ulong,Goods>), typeof(IEqualityComparer<ulong>)))
		{
			IDictionary<ulong,Goods> arg0 = (IDictionary<ulong,Goods>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<ulong,Goods>));
			IEqualityComparer<ulong> arg1 = (IEqualityComparer<ulong>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<ulong>));
			Dictionary<ulong,Goods> obj = new Dictionary<ulong,Goods>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<ulong,Goods>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<ulong,Goods>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<ulong,Goods> obj = (Dictionary<ulong,Goods>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<ulong,Goods> obj = (Dictionary<ulong,Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<ulong,Goods>");
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<ulong,Goods> obj = (Dictionary<ulong,Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<ulong,Goods>");
		Dictionary<ulong,Goods>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
