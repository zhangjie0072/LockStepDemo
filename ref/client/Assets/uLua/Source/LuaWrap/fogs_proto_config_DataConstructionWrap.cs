...
public class fogs_proto_config_DataConstructionWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			new LuaMethod("New", _Createfogs_proto_config_DataConstruction),
		...
		LuaScriptMgr.RegisterLib(L, "fogs.proto.config.DataConstruction", typeof(fogs.proto.config.DataConstruction), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(fogs.proto.config.DataConstruction);
