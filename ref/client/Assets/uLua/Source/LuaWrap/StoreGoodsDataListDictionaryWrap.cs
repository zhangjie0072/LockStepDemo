...
public class StoreGoodsDataListDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateStoreGoodsDataListDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "StoreGoodsDataListDictionary", typeof(Dictionary<uint,List<StoreGoodsData>>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateStoreGoodsDataListDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,List<StoreGoodsData>> obj = new Dictionary<uint,List<StoreGoodsData>>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,List<StoreGoodsData>> obj = new Dictionary<uint,List<StoreGoodsData>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,List<StoreGoodsData>>)))
		{
			IDictionary<uint,List<StoreGoodsData>> arg0 = (IDictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,List<StoreGoodsData>>));
			Dictionary<uint,List<StoreGoodsData>> obj = new Dictionary<uint,List<StoreGoodsData>>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,List<StoreGoodsData>> obj = new Dictionary<uint,List<StoreGoodsData>>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,List<StoreGoodsData>>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,List<StoreGoodsData>> arg0 = (IDictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,List<StoreGoodsData>>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,List<StoreGoodsData>> obj = new Dictionary<uint,List<StoreGoodsData>>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,List<StoreGoodsData>>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,List<StoreGoodsData>>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,List<StoreGoodsData>> obj = (Dictionary<uint,List<StoreGoodsData>>)o;
	...
	static int get_Item(IntPtr L)
	{
		...
		Dictionary<uint,List<StoreGoodsData>> obj = (Dictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<StoreGoodsData>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		List<StoreGoodsData> o = obj[arg0];
	...
	static int set_Item(IntPtr L)
	{
		...
		Dictionary<uint,List<StoreGoodsData>> obj = (Dictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<StoreGoodsData>>");
		uint arg0 = (uint)LuaScriptMgr.GetNumber(L, 2);
		List<StoreGoodsData> arg1 = (List<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 3, typeof(List<StoreGoodsData>));
		obj[arg0] = arg1;
		return 0;
	}
	...
	static int ContainsValue(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		Dictionary<uint,List<StoreGoodsData>> obj = (Dictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<StoreGoodsData>>");
		List<StoreGoodsData> arg0 = (List<StoreGoodsData>)LuaScriptMgr.GetNetObject(L, 2, typeof(List<StoreGoodsData>));
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,List<StoreGoodsData>> obj = (Dictionary<uint,List<StoreGoodsData>>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,List<StoreGoodsData>>");
		Dictionary<uint,List<StoreGoodsData>>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
