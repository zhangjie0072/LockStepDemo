...
public class QualifyingAwardsDataListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateQualifyingAwardsDataList),
		...
		LuaScriptMgr.RegisterLib(L, "QualifyingAwardsDataList", typeof(List<QualifyingAwardsData>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateQualifyingAwardsDataList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<QualifyingAwardsData> obj = new List<QualifyingAwardsData>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<QualifyingAwardsData> obj = new List<QualifyingAwardsData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<QualifyingAwardsData>)))
		{
			IEnumerable<QualifyingAwardsData> arg0 = (IEnumerable<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<QualifyingAwardsData>));
			List<QualifyingAwardsData> obj = new List<QualifyingAwardsData>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<QualifyingAwardsData>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		IEnumerable<QualifyingAwardsData> arg0 = (IEnumerable<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<QualifyingAwardsData>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		System.Collections.ObjectModel.ReadOnlyCollection<QualifyingAwardsData> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
			QualifyingAwardsData[] objs0 = LuaScriptMgr.GetArrayObject<QualifyingAwardsData>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			QualifyingAwardsData[] objs1 = LuaScriptMgr.GetArrayObject<QualifyingAwardsData>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		QualifyingAwardsData o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<QualifyingAwardsData> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<QualifyingAwardsData> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<QualifyingAwardsData>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<QualifyingAwardsData> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<QualifyingAwardsData>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		Action<QualifyingAwardsData> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<QualifyingAwardsData>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		List<QualifyingAwardsData>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<QualifyingAwardsData> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<QualifyingAwardsData> arg1 = (IEnumerable<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<QualifyingAwardsData>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<QualifyingAwardsData>), typeof(Comparison<QualifyingAwardsData>)))
		{
			List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
			Comparison<QualifyingAwardsData> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<QualifyingAwardsData>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<QualifyingAwardsData>), typeof(IComparer<QualifyingAwardsData>)))
		{
			List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
			IComparer<QualifyingAwardsData> arg0 = (IComparer<QualifyingAwardsData>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<QualifyingAwardsData> arg2 = (IComparer<QualifyingAwardsData>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<QualifyingAwardsData>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<QualifyingAwardsData>.Sort");
		}
	...
	static int ToArray(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<QualifyingAwardsData> obj = (List<QualifyingAwardsData>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<QualifyingAwardsData>");
		QualifyingAwardsData[] o = obj.ToArray();
