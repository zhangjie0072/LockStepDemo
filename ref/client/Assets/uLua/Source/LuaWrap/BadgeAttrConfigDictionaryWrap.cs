...
public class BadgeAttrConfigDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateBadgeAttrConfigDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "BadgeAttrConfigDictionary", typeof(Dictionary<uint,BadgeAttrBaseConfig>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateBadgeAttrConfigDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,BadgeAttrBaseConfig> obj = new Dictionary<uint,BadgeAttrBaseConfig>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,BadgeAttrBaseConfig> obj = new Dictionary<uint,BadgeAttrBaseConfig>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,BadgeAttrBaseConfig>)))
		{
			IDictionary<uint,BadgeAttrBaseConfig> arg0 = (IDictionary<uint,BadgeAttrBaseConfig>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,BadgeAttrBaseConfig>));
			Dictionary<uint,BadgeAttrBaseConfig> obj = new Dictionary<uint,BadgeAttrBaseConfig>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,BadgeAttrBaseConfig> obj = new Dictionary<uint,BadgeAttrBaseConfig>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,BadgeAttrBaseConfig>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,BadgeAttrBaseConfig> arg0 = (IDictionary<uint,BadgeAttrBaseConfig>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,BadgeAttrBaseConfig>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,BadgeAttrBaseConfig> obj = new Dictionary<uint,BadgeAttrBaseConfig>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,BadgeAttrBaseConfig>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,BadgeAttrBaseConfig>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,BadgeAttrBaseConfig> obj = (Dictionary<uint,BadgeAttrBaseConfig>)o;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,BadgeAttrBaseConfig> obj = (Dictionary<uint,BadgeAttrBaseConfig>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,BadgeAttrBaseConfig>");
		Dictionary<uint,BadgeAttrBaseConfig>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
