...
public class BullFightLevelDictionaryWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateBullFightLevelDictionary),
		...
		LuaScriptMgr.RegisterLib(L, "BullFightLevelDictionary", typeof(Dictionary<uint,BullFightLevel>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateBullFightLevelDictionary(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			Dictionary<uint,BullFightLevel> obj = new Dictionary<uint,BullFightLevel>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			Dictionary<uint,BullFightLevel> obj = new Dictionary<uint,BullFightLevel>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,BullFightLevel>)))
		{
			IDictionary<uint,BullFightLevel> arg0 = (IDictionary<uint,BullFightLevel>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,BullFightLevel>));
			Dictionary<uint,BullFightLevel> obj = new Dictionary<uint,BullFightLevel>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(int), typeof(IEqualityComparer<uint>)))
		{
			...
			Dictionary<uint,BullFightLevel> obj = new Dictionary<uint,BullFightLevel>(arg0,arg1);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(IDictionary<uint,BullFightLevel>), typeof(IEqualityComparer<uint>)))
		{
			IDictionary<uint,BullFightLevel> arg0 = (IDictionary<uint,BullFightLevel>)LuaScriptMgr.GetNetObject(L, 1, typeof(IDictionary<uint,BullFightLevel>));
			IEqualityComparer<uint> arg1 = (IEqualityComparer<uint>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEqualityComparer<uint>));
			Dictionary<uint,BullFightLevel> obj = new Dictionary<uint,BullFightLevel>(arg0,arg1);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: Dictionary<uint,BullFightLevel>.New");
		}

		return 0;
	}

	static Type classType = typeof(Dictionary<uint,BullFightLevel>);
	...
	static int get_Count(IntPtr L)
	{
		...
		Dictionary<uint,BullFightLevel> obj = (Dictionary<uint,BullFightLevel>)o;
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Dictionary<uint,BullFightLevel> obj = (Dictionary<uint,BullFightLevel>)LuaScriptMgr.GetNetObjectSelf(L, 1, "Dictionary<uint,BullFightLevel>");
		Dictionary<uint,BullFightLevel>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
}
