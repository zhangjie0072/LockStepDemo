...
public class MailInfoListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateMailInfoList),
		...
		LuaScriptMgr.RegisterLib(L, "MailInfoList", typeof(List<fogs.proto.msg.MailInfo>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateMailInfoList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<fogs.proto.msg.MailInfo> obj = new List<fogs.proto.msg.MailInfo>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<fogs.proto.msg.MailInfo> obj = new List<fogs.proto.msg.MailInfo>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<fogs.proto.msg.MailInfo>)))
		{
			IEnumerable<fogs.proto.msg.MailInfo> arg0 = (IEnumerable<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<fogs.proto.msg.MailInfo>));
			List<fogs.proto.msg.MailInfo> obj = new List<fogs.proto.msg.MailInfo>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<fogs.proto.msg.MailInfo>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		IEnumerable<fogs.proto.msg.MailInfo> arg0 = (IEnumerable<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<fogs.proto.msg.MailInfo>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		System.Collections.ObjectModel.ReadOnlyCollection<fogs.proto.msg.MailInfo> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
			fogs.proto.msg.MailInfo[] objs0 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.MailInfo>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			fogs.proto.msg.MailInfo[] objs1 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.MailInfo>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		fogs.proto.msg.MailInfo o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<fogs.proto.msg.MailInfo> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<fogs.proto.msg.MailInfo> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<fogs.proto.msg.MailInfo>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<fogs.proto.msg.MailInfo> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<fogs.proto.msg.MailInfo>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		Action<fogs.proto.msg.MailInfo> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<fogs.proto.msg.MailInfo>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		List<fogs.proto.msg.MailInfo>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<fogs.proto.msg.MailInfo> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<fogs.proto.msg.MailInfo> arg1 = (IEnumerable<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<fogs.proto.msg.MailInfo>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.MailInfo>), typeof(Comparison<fogs.proto.msg.MailInfo>)))
		{
			List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
			Comparison<fogs.proto.msg.MailInfo> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.MailInfo>), typeof(IComparer<fogs.proto.msg.MailInfo>)))
		{
			List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
			IComparer<fogs.proto.msg.MailInfo> arg0 = (IComparer<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<fogs.proto.msg.MailInfo> arg2 = (IComparer<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<fogs.proto.msg.MailInfo>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.MailInfo>.Sort");
		}
	...
	static int ToArray(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.MailInfo> obj = (List<fogs.proto.msg.MailInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.MailInfo>");
		fogs.proto.msg.MailInfo[] o = obj.ToArray();
