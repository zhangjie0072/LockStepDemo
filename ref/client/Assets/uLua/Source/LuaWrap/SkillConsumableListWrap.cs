...
public class SkillConsumableListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateSkillConsumableList),
		...
		LuaScriptMgr.RegisterLib(L, "SkillConsumableList", typeof(List<SkillConsumable>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateSkillConsumableList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<SkillConsumable> obj = new List<SkillConsumable>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<SkillConsumable> obj = new List<SkillConsumable>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<SkillConsumable>)))
		{
			IEnumerable<SkillConsumable> arg0 = (IEnumerable<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<SkillConsumable>));
			List<SkillConsumable> obj = new List<SkillConsumable>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<SkillConsumable>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<SkillConsumable> obj = (List<SkillConsumable>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
		IEnumerable<SkillConsumable> arg0 = (IEnumerable<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<SkillConsumable>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
		System.Collections.ObjectModel.ReadOnlyCollection<SkillConsumable> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
			SkillConsumable[] objs0 = LuaScriptMgr.GetArrayObject<SkillConsumable>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			SkillConsumable[] objs1 = LuaScriptMgr.GetArrayObject<SkillConsumable>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		SkillConsumable o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<SkillConsumable> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<SkillConsumable> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<SkillConsumable>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<SkillConsumable> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<SkillConsumable>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
		Action<SkillConsumable> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<SkillConsumable>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
		List<SkillConsumable>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<SkillConsumable> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<SkillConsumable> arg1 = (IEnumerable<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<SkillConsumable>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<SkillConsumable>), typeof(Comparison<SkillConsumable>)))
		{
			List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
			Comparison<SkillConsumable> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<SkillConsumable>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<SkillConsumable>), typeof(IComparer<SkillConsumable>)))
		{
			List<SkillConsumable> obj = (List<SkillConsumable>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<SkillConsumable>");
			IComparer<SkillConsumable> arg0 = (IComparer<SkillConsumable>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<SkillConsumable> arg2 = (IComparer<SkillConsumable>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<SkillConsumable>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<SkillConsumable>.Sort");
		}
