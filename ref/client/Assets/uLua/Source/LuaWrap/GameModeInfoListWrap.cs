...
public class GameModeInfoListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateGameModeInfoList),
		...
		LuaScriptMgr.RegisterLib(L, "GameModeInfoList", typeof(List<fogs.proto.msg.GameModeInfo>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGameModeInfoList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<fogs.proto.msg.GameModeInfo> obj = new List<fogs.proto.msg.GameModeInfo>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<fogs.proto.msg.GameModeInfo> obj = new List<fogs.proto.msg.GameModeInfo>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<fogs.proto.msg.GameModeInfo>)))
		{
			IEnumerable<fogs.proto.msg.GameModeInfo> arg0 = (IEnumerable<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<fogs.proto.msg.GameModeInfo>));
			List<fogs.proto.msg.GameModeInfo> obj = new List<fogs.proto.msg.GameModeInfo>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<fogs.proto.msg.GameModeInfo>);
	...
	static int get_Capacity(IntPtr L)
	{
		...
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)o;
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		IEnumerable<fogs.proto.msg.GameModeInfo> arg0 = (IEnumerable<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<fogs.proto.msg.GameModeInfo>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		System.Collections.ObjectModel.ReadOnlyCollection<fogs.proto.msg.GameModeInfo> o = obj.AsReadOnly();
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
			fogs.proto.msg.GameModeInfo[] objs0 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.GameModeInfo>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			fogs.proto.msg.GameModeInfo[] objs1 = LuaScriptMgr.GetArrayObject<fogs.proto.msg.GameModeInfo>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.CopyTo");
		}
	...
	static int Find(IntPtr L)
	{
		...
		fogs.proto.msg.GameModeInfo o = obj.Find(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindAll(IntPtr L)
	{
		...
		List<fogs.proto.msg.GameModeInfo> o = obj.FindAll(arg0);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<fogs.proto.msg.GameModeInfo> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<fogs.proto.msg.GameModeInfo>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<fogs.proto.msg.GameModeInfo> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<fogs.proto.msg.GameModeInfo>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		Action<fogs.proto.msg.GameModeInfo> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<fogs.proto.msg.GameModeInfo>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		List<fogs.proto.msg.GameModeInfo>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<fogs.proto.msg.GameModeInfo> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.IndexOf");
		}
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<fogs.proto.msg.GameModeInfo> arg1 = (IEnumerable<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<fogs.proto.msg.GameModeInfo>));
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.GameModeInfo>), typeof(Comparison<fogs.proto.msg.GameModeInfo>)))
		{
			List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
			Comparison<fogs.proto.msg.GameModeInfo> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<fogs.proto.msg.GameModeInfo>), typeof(IComparer<fogs.proto.msg.GameModeInfo>)))
		{
			List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
			IComparer<fogs.proto.msg.GameModeInfo> arg0 = (IComparer<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<fogs.proto.msg.GameModeInfo> arg2 = (IComparer<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<fogs.proto.msg.GameModeInfo>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<fogs.proto.msg.GameModeInfo>.Sort");
		}
	...
	static int ToArray(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<fogs.proto.msg.GameModeInfo> obj = (List<fogs.proto.msg.GameModeInfo>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<fogs.proto.msg.GameModeInfo>");
		fogs.proto.msg.GameModeInfo[] o = obj.ToArray();
