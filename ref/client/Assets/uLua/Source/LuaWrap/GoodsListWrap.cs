...
public class GoodsListWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("New", _CreateGoodsList),
		...
		LuaScriptMgr.RegisterLib(L, "GoodsList", typeof(List<Goods>), regs, fields, typeof(object));
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGoodsList(IntPtr L)
	{
		int count = LuaDLL.lua_gettop(L);

		if (count == 0)
		{
			List<Goods> obj = new List<Goods>();
		...
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(int)))
		{
			...
			List<Goods> obj = new List<Goods>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		else if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<Goods>)))
		{
			IEnumerable<Goods> arg0 = (IEnumerable<Goods>)LuaScriptMgr.GetNetObject(L, 1, typeof(IEnumerable<Goods>));
			List<Goods> obj = new List<Goods>(arg0);
			LuaScriptMgr.PushObject(L, obj);
			return 1;
		}
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.New");
		}

		return 0;
	}

	static Type classType = typeof(List<Goods>);
	...
	static int Add(IntPtr L)
	{
		...
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
	...
	static int AddRange(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		IEnumerable<Goods> arg0 = (IEnumerable<Goods>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<Goods>));
		obj.AddRange(arg0);
		return 0;
	}
	...
	static int AsReadOnly(IntPtr L)
	{
		...
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		System.Collections.ObjectModel.ReadOnlyCollection<Goods> o = obj.AsReadOnly();
	...
	static int BinarySearch(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			Goods arg0 = (Goods)LuaScriptMgr.GetNetObject(L, 2, typeof(Goods));
			IComparer<Goods> arg1 = (IComparer<Goods>)LuaScriptMgr.GetNetObject(L, 3, typeof(IComparer<Goods>));
		...
		else if (count == 5)
		{
			...
			Goods arg2 = (Goods)LuaScriptMgr.GetNetObject(L, 4, typeof(Goods));
			IComparer<Goods> arg3 = (IComparer<Goods>)LuaScriptMgr.GetNetObject(L, 5, typeof(IComparer<Goods>));
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.BinarySearch");
		}
	...
	static int CopyTo(IntPtr L)
	{
		...
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			Goods[] objs0 = LuaScriptMgr.GetArrayObject<Goods>(L, 2);
			obj.CopyTo(objs0);
			return 0;
		}
		else if (count == 3)
		...
		else if (count == 5)
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Goods[] objs1 = LuaScriptMgr.GetArrayObject<Goods>(L, 3);
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.CopyTo");
		}
	...
	static int Exists(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		Predicate<Goods> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Predicate<Goods>)LuaScriptMgr.GetNetObject(L, 2, typeof(Predicate<Goods>));
		}
		else
		{
	...
	static int FindIndex(IntPtr L)
	{
		...
		else if (count == 3)
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			Predicate<Goods> arg1 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Predicate<Goods>)LuaScriptMgr.GetNetObject(L, 3, typeof(Predicate<Goods>));
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			Predicate<Goods> arg2 = null;
			LuaTypes funcType4 = LuaDLL.lua_type(L, 4);

			if (funcType4 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Predicate<Goods>)LuaScriptMgr.GetNetObject(L, 4, typeof(Predicate<Goods>));
			}
			else
			{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.FindIndex");
		}
	...
	static int FindLastIndex(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.FindLastIndex");
		}
	...
	static int ForEach(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 2);
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		Action<Goods> arg0 = null;
		LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

		if (funcType2 != LuaTypes.LUA_TFUNCTION)
		{
			 arg0 = (Action<Goods>)LuaScriptMgr.GetNetObject(L, 2, typeof(Action<Goods>));
		}
		else
		{
			LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
	...
	static int GetEnumerator(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		List<Goods>.Enumerator o = obj.GetEnumerator();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int GetRange(IntPtr L)
	{
		...
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
		List<Goods> o = obj.GetRange(arg0,arg1);
		LuaScriptMgr.PushObject(L, o);
		return 1;
	}
	...
	static int IndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.IndexOf");
		}
	...
	static int Insert(IntPtr L)
	{
		...
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		Goods arg1 = (Goods)LuaScriptMgr.GetNetObject(L, 3, typeof(Goods));
	...
	static int InsertRange(IntPtr L)
	{
		...
		List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
		int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
		IEnumerable<Goods> arg1 = (IEnumerable<Goods>)LuaScriptMgr.GetNetObject(L, 3, typeof(IEnumerable<Goods>));
	...
	static int LastIndexOf(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.LastIndexOf");
		}
	...
	static int Reverse(IntPtr L)
	{
		...
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.Reverse");
		}
	...
	static int Sort(IntPtr L)
	{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<Goods>), typeof(Comparison<Goods>)))
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			Comparison<Goods> arg0 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (Comparison<Goods>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(List<Goods>), typeof(IComparer<Goods>)))
		{
			List<Goods> obj = (List<Goods>)LuaScriptMgr.GetNetObjectSelf(L, 1, "List<Goods>");
			IComparer<Goods> arg0 = (IComparer<Goods>)LuaScriptMgr.GetLuaObject(L, 2);
			obj.Sort(arg0);
			return 0;
		}
		else if (count == 4)
		{
			...
			int arg0 = (int)LuaScriptMgr.GetNumber(L, 2);
			int arg1 = (int)LuaScriptMgr.GetNumber(L, 3);
			IComparer<Goods> arg2 = (IComparer<Goods>)LuaScriptMgr.GetNetObject(L, 4, typeof(IComparer<Goods>));
			obj.Sort(arg0,arg1,arg2);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: List<Goods>.Sort");
		}
