...
public class ProfilerWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("maxNumberOfSamplesPerFrame", get_maxNumberOfSamplesPerFrame, set_maxNumberOfSamplesPerFrame),
			new LuaField("usedHeapSize", get_usedHeapSize, null),
		};

		LuaScriptMgr.RegisterLib(L, "UnityEngine.Profiler", typeof(Profiler), regs, fields, typeof(object));
	}
	...
	static Type classType = typeof(Profiler);
	...
	{
		LuaScriptMgr.Push(L, Profiler.maxNumberOfSamplesPerFrame);
		return 1;
	}
	...
	{
		Profiler.maxNumberOfSamplesPerFrame = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
