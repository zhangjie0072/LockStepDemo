...
public static class LuaBinding
{
	...
	[MenuItem("Lua/Gen Custom Lua Wrap Files", false, 22)]
	...
	[MenuItem("Lua/Gen Custom Lua Wrap Files and Binder", false, 22)]
	public static void BindingCustomWithBinder()
	{
		BindType[] list = WrapFile.CustomBinds;
		if(list.Length<=0)
		{
    ...
    [MenuItem("Lua/Gen Lua Wrap Files", false, 21)]
    ...
    [MenuItem("Lua/Clear LuaBinder File + Wrap Files", false, 24)]
    ...
    [MenuItem("Lua/Gen Lua Delegates", false, 22)]
    static void GenLuaDelegates()
    {
        ...
        list.AddRange(new DelegateType[] {
            ...
            _DT(typeof(MainPlayer.DataChangedDelegate)),
        });
    ...
    [MenuItem("Lua/Build Lua without jit", false, 23)]
